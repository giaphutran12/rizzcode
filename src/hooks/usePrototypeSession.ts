...
/**
 * The ORIGINAL prototype session logic, kept only so the historical
 * /control reference view keeps working. The production practice flow uses
 * usePracticeSession (three authored turns, persona engine, real judge).
 */
